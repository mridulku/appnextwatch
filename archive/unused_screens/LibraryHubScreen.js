...
const SEGMENTS = ['Gym', 'Exercises'];

function LibraryHubScreen({ navigation, route }) {
  const [segment, setSegment] = useState(route.params?.initialSegment === 'Exercises' ? 'Exercises' : 'Gym');
  ...
  useEffect(() => {
    ...
    if (route.params?.initialSegment === 'Gym') {
      setSegment('Gym');
    }
        ...
        <View style={styles.topCard}>
          <View style={styles.topTitleRow}>
            <View>
              ...
              <Text style={styles.subtitle}>Gym machines and exercise intelligence in one place.</Text>
            </View>
