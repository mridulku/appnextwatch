...
function FoodChatScreen() {
  const [messages, setMessages] = useState([
    { id: 'intro', role: 'assistant', text: 'Food chat ready. Ask meal planning, substitutions, or pantry ideas.' },
  ]);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        <Text style={styles.title}>Food Chat</Text>
        ...
        <View style={styles.inputRow}>
          <TextInput
            ...
            style={styles.input}
            placeholder="Ask about food or meal plan"
